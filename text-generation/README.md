...
Clone or download the NI-NLM materials repository (`git clone https://gitlab.fit.cvut.cz/NI-NLM/ni-nlm-materials`) and navigate to the subfolder `text-generation`. Make sure you have Python 3 installed on your system.
...
Please enter your answers to tasks #1 - #5 in the following [shared Google doc](https://docs.google.com/document/d/1UBxGBHy8cvQ94c6pU1X7vcnVi7Vr6KZsUZ7P-hWpQ1A/edit?usp=sharing).
...
Note that the weather data was **up-to-date for 9 March 2026**: for evaluation the accuracy of the forecasts, feel free to check https://openweathermap.org!
